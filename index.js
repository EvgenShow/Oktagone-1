...
bot.onText(/\/price/, (msg) => {
  const chatId = msg.chat.id;
  const message = '1. Лайк - 300 рублей 2. Лайк + Комментарий - 500 рублей 3. Реклама в начале ролика - 65000 рублей 4. Преролл для сайтов, серверов и т.п. - от 50000 рублей 5. Заказной стрим (Ваша игра, ваш сервер, ваше время и т.п.) - от 30000р/1час 6. Пиар на стриме - 10000рублей (большая аудитория за короткое время) (!)кроме каналов и майнкрафт серверов(!) 7. Индивидуальные предложения - Индивидуальная цена ------------------------------------------------------------------------------------------------------------------------------------------ Услуги:1. Друг на час (Общение с вами в ВК/Скайпе как с другом) - 25000р/час2. Поиграть с вами - 40000р/час + копия игры, если у меня её нет3. Ответы на ваши вопросы в течении 20мин в ВК - 10000р4. Консультация (Что нужно делать для того чтобы стать популярным) - 30000р 5. Добавить в друзья в ВК - 2000 рублей';
  bot.sendMessage(chatId, message);
});
